...
class ABError {
    ...
    lazy var description: Description = {
        ...
        case .wrongAuthCredentials:
            return .notification(description: .init(icon: R.image.popup.alert()!, description: R.string.localization.shared_aberror_wrong_credentials.localized()))
        ...
        case .otpNotFound:
            return .notification(description: .init(icon: R.image.popup.alert()!, description: R.string.localization.shared_aberror_otp_not_found.localized()))
        case .notConnected:

...
struct R: Rswift.Validatable {
  ...
  struct image {
    ...
    /// This `R.image.contact` struct is generated, and contains static references to 2 images.
    struct contact {
      /// Image `contact_phone`.
  ...
  struct string {
    /// This `R.string.localization` struct is generated, and contains static references to 561 localization keys.
    struct localization {

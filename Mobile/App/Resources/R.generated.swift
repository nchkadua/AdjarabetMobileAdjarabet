...
struct R: Rswift.Validatable {
  ...
  struct file {
    ...
    /// Resource file `ApplePayScript.js`.
    static let applePayScriptJs = Rswift.FileResource(bundle: R.hostingBundle, name: "ApplePayScript", pathExtension: "js")
    ...
    /// `bundle.url(forResource: "ApplePayScript", withExtension: "js")`
    static func applePayScriptJs(_: Void = ()) -> Foundation.URL? {
      let fileResource = R.file.applePayScriptJs
      return fileResource.bundle.url(forResource: fileResource)
    }
  ...
  struct string {
    /// This `R.string.localization` struct is generated, and contains static references to 501 localization keys.
    struct localization {
